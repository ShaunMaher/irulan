...
function wikipages(_app, router) {
  app = module.app = _app;
  ...
  app.ClientScripts['single page application'].push({
    name: 'marked.min.js',
    offline_path: app.Settings['node modules directory'] + '/marked/marked.min.js'
  })
  //  WikiPage and markdownRenderer providers
  app.ClientScripts['single page application'].push({
    name: 'components.wikipages.js',
    offline_path: app.Settings['node modules directory'] + '/wikipages/components.wikipages.js'
  })
...
function get(req, res, next) {
  ...
  context.fileName = app.Settings['wiki content directory'] + context.pageName + ".md";
